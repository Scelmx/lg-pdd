...
//    * @returns
//    */
//   async httpAgent(url: string, method = 'get', data = {}, option = {}) {
//     const defOption = {
//       dataType: 'json'
//     };
...
//    * @returns {boolean}
//    */
//   isSquare(p1: any, p2: any, p3: any, p4: any) {
//     const distSq = (p: any, q: any) => (p.x - q.x) * (p.x - q.x) +
//       (p.y - q.y) * (p.y - q.y);
...
//       return false;
//     }
//     const rectPoints = layer.points.map((x: any) => this.toPoint(x.point, layer));
...
//     const hasCurveTo = layer.points.filter((x: any) => x.hasCurveTo === true).length === 4;
...
//    * @returns
//    */
//   static getElementUnit(value: any) {
...
//   static toLine(name: string): string {
//     return name.replace(/([A-Z])/g, '-$1').toLowerCase();
//   }

//   objectToLine(obj: any) {
//     const keys = Object.keys(obj);
//     const result: any = {};
//     for (let i = 0, len = keys.length; i < len; i++) {
//       result[tools.toLine(keys[i])] = obj[keys[i]];
//     }
//     return result;
//   }
